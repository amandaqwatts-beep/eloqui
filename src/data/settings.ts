...
export const LESSONS_PER_UNIT = 142;
export const LESSONS_PER_UNIT_BY_LANGUAGE: Record<Language, number> = { latin: 142, greek: 0, hebrew: 0, english: 10 };
...
export const LATIN_LESSONS = 142;
