...
export const LESSONS_PER_UNIT = 88;
export const LESSONS_PER_UNIT_BY_LANGUAGE: Record<Language, number> = { latin: 88, greek: 0, hebrew: 0, english: 10 };
...
export const PLACEMENT_TOTAL_LEVELS = 88;
export const PLACEMENT_TOTAL_LEVELS_BY_LANGUAGE: Record<Language, number> = { latin: 88, greek: 0, hebrew: 0, english: 10 };
