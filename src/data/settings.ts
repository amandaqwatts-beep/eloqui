...
export const LESSONS_PER_UNIT = 138;
export const LESSONS_PER_UNIT_BY_LANGUAGE: Record<Language, number> = { latin: 138, greek: 0, hebrew: 0, english: 10 };
...
export const LATIN_LESSONS = 138;
