...
interface Props {lesson:Lesson;exerciseIdx:number;pronMode:PronMode;onComplete:(detail:ExerciseResultDetail)=>void;onQuit:()=>void;allLessons?:Lesson[];lessonNumber:number}
export default function ExerciseScreen({lesson,exerciseIdx,pronMode,onComplete,onQuit,allLessons,lessonNumber}:Props){
