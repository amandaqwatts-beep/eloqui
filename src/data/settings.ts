...
export const LESSONS_PER_UNIT = 70;
export const LESSONS_PER_UNIT_BY_LANGUAGE: Record<Language, number> = { latin: 70, greek: 0, hebrew: 0, english: 10 };
...
export const PLACEMENT_TOTAL_LEVELS = 70;
export const PLACEMENT_TOTAL_LEVELS_BY_LANGUAGE: Record<Language, number> = { latin: 70, greek: 0, hebrew: 0, english: 10 };
