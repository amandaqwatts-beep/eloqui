...
interface Props {lesson:Lesson;exerciseIdx:number;pronMode:PronMode;onComplete:(detail:ExerciseResultDetail)=>void;onQuit:()=>void;allLessons?:Lesson[];lessonNumber:number;/** Beta bug-report affordance (PR #78 pattern) — optional; route renders the one BugReportDialog. */onReportBug?:()=>void}
export default function ExerciseScreen({lesson,exerciseIdx,pronMode,onComplete,onQuit,allLessons,lessonNumber,onReportBug}:Props){
